...
function PropertyList() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get('https://8080-deefcbababbddcfcdcebdafbcfcbaedbffbeeaadbbb.project.examly.io/properties/admin', {
          headers: {
  ...
  const deleteProperty = async (propertyId) => {
    ...
    if (confirmDelete) {
      try {
        await axios.delete(`https://8080-deefcbababbddcfcdcebdafbcfcbaedbffbeeaadbbb.project.examly.io/properties/${propertyId}`);
