  ...
  useEffect(() => {
    const fetchUserData = async () => {
      try {
        ...
        const response = await axios.get(`https://8080-feaaeedcbbebeeddcfcdcebdafbeaeaadbdbabf.project.examly.io/users/id?id=${userId}`, {
          headers: {
  ...
  const handlePayment = async (event) => {
    try {
      ...
      const orderresponse = await axios.post(
        'https://8080-feaaeedcbbebeeddcfcdcebdafbeaeaadbdbabf.project.examly.io/purchase/order',
        null,
        {
          params: {
      ...
      const options = {
        ...
        handler: async function (response) {
          ...
          try {
            await axios.put(
              `https://8080-feaaeedcbbebeeddcfcdcebdafbeaeaadbdbabf.project.examly.io/purchase/order/${id}`,
              null,
              {
                params: {
